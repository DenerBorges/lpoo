...
public class Corrida {
    ...
    public Corrida(long id, String tipoPagamento, String detalhesPagamento, Calendar dataInicio, double preco, Usuario usuario, Motorista motorista) {
        super();
        this.id = id;
    ...
    public String toString() {
        return "\nCorrida{" + "id=" + id + ", tipoPagamento='" + tipoPagamento + '\'' + ", detalhesPagamento='" + detalhesPagamento + '\'' +
                ", dataInicio=" + calendarToString(dataInicio) + ", preco=" + preco + ", usuario=" + usuario + ", motorista=" + motorista + '}';
    }
